...
// المشروبات بتتقدم في كبايات قزاز — الأكواب الورقية/البلاستيك للتيك أواي فقط (خصم يدوي)
const productDefs = [
  // --- ساخنة ---
  ...
  // --- باردة ---
  { cat: 'cold', name: 'آيس كوفي',       price: 55, emoji: '❄️', cold: true, recipe: { 'بن': 10, 'حليب': 100, 'سكر': 10 } },
  { cat: 'cold', name: 'آيس لاتيه',      price: 60, emoji: '❄️', cold: true, recipe: { 'بن': 8, 'حليب': 180 } },
  { cat: 'cold', name: 'آيس موكا',       price: 65, emoji: '❄️', cold: true, recipe: { 'بن': 8, 'حليب': 150, 'كاكاو': 20 } },
