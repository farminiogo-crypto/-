...
## الحالة الحالية
النظام مكتمل ومترابط: POS بالترابيزات (فتح حساب باسم الزبون + إضافة ترابيزة من الشاشة)، شيفتات بجرد الدرج (اسم الكاشير إجباري)، مصروفات، مخزون بوصفات وخصم تلقائي عند البيع وسجل حركة وتقدير أكواب متبقية وعبوات (خلّصت كيس) ومستويي تنبيه (قرب يخلص/اطلب فوراً)، صفحة فواتير سابقة بفلتر وبحث وإعادة طباعة، إدارة ترابيزات (إضافة/تسمية/حذف)، لوحة تحكم بتنبيهات النواقص، إدارة منيو بمكتبة أيقونات (بدون تكرار) ومحرر وصفات، خط Cairo مدمج محلياً، تصميم متجاوب (موبايل ≤640px، تابلت ≤900px).
